...
const UserList = ({ user, currentUser, onOpenChat, onOpenModal }) => {
    return (
        <div
            className={`${user?.role === 'owner' ? 'shadow-md shadow-error animate-pulse' : ''} max-w-[90%] mx-auto relative flex items-center flex-1 w-full gap-3 p-2 mb-2 bg-base-200 rounded cursor-pointer hover:Bbase-100 transition`}
